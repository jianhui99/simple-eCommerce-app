      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-10">
          ...
          @forelse ($items as $item)
            @forelse ($item->order_product_list as $list)
              <div class="card rounded-3 mb-4">
                <div class="card-body p-4">
                  <div class="row d-flex justify-content-between align-items-center">
                    <div class="col-md-2 col-lg-2 col-xl-2">
                      <img
                        src="{{ $list['product_info']->product_image_list[0]->src }}"
                        class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </div>
                    <div class="col-md-3 col-lg-4 col-xl-4">
                      <p class="lead fw-normal mb-2">{{ $list['product_info']->product_name }}</p>
                      <p><span class="text-muted">Sku: </span>{{ $list['product_info']->sku }} 
                    </div>
                    <div class="col-md-3 col-lg-1 col-xl-1 offset-lg-1">
                      <span class="mb-0">RM{{ $list['product_info']->regular_price }}</span>
                    </div>
                    <div class="col-md-3 col-lg-1 col-xl-1 d-flex">
                      x<span>{{$list['qty']}}</span>
                    </div>
                    <div class="col-md-3 col-lg-1 col-xl-1 offset-lg-1">
